# v0.0.5 — Release assets (manifest)

Binaries are **not** stored in this git repository; they are attached to the [GitHub Release for `v0.0.5`](https://github.com/OpenKnots/okcode/releases/tag/v0.0.5) by the [Release Desktop workflow](../../.github/workflows/release.yml).
...
| `okcode-RELEASE-NOTES.md`   | [v0.0.5.md](../v0.0.5.md)             |
